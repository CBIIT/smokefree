...
<!--  Begin logo bar -->
    ...
    <div class="live-chat-bar">
        <form action="https://livehelp.cancer.gov/app/chat/chat_landing" id="live-chat-bar-form" method="POST"><input name="_icf_22" style="display: none;" value="91" type="text">
