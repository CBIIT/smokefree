...
<div class="webform-confirmation">
  ...
  <?php endif; ?>
	...
	<?php if($node->nid == NICOTINE_ADDICTION_QUIZ): ?>
		<div id="medication">
			<?php if($score <= 2): ?>
	...
	<?php if($node->nid == NICOTINE_WITHDRAWAL_SYMPTOMS_QUIZ): ?>
		<div id="withdrawal">
	...
	<?php
    if($node->nid == SECOND_HAND_SMOKE_QUIZ) {
  ...
  ?>
	...
	<?php if($node->nid == SAVINGS_CALCULATOR): ?>
    <?php
	...
	<?php if($node->nid == WHY_I_USE_TOBACCO_QUIZ): ?>
    <?php
    $stimulation_total = 0;
    $handling_total = 0;
    $pleasure_total = 0;
