...
function bootstrap_preprocess_page(&$variables) {
  // Add preprocess for content type override
  ...
  drupal_add_js(path_to_theme() . '/js/bootstrap-datepicker.min.js');
  drupal_add_js(path_to_theme() . '/js/build-your-quit-plan.js');
