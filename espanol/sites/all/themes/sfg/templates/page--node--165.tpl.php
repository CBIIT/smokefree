...
<link rel="stylesheet" type="text/css" href="/<?php echo path_to_theme(); ?>/css/quit-plan-non-vet.css" />
<link rel="stylesheet" type="text/css" href="/<?php echo path_to_theme(); ?>/css/bootstrap-datepicker/bootstrap-datepicker.standalone.min.css" />
...
<script src="/<?php echo path_to_theme(); ?>/js/jquery.waypoints.min.js"></script>
<script src="/<?php echo path_to_theme(); ?>/js/bootstrap-datepicker.min.js"></script>
<script src="/<?php echo path_to_theme(); ?>/js/build-your-quit-plan.js"></script>
<script src="/<?php echo path_to_theme(); ?>/js/build-your-quit-plan-progress-bar.js"></script>
