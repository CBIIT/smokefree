      ...
      <div class="section-body" id="top_trigger">
        <ul aria-hidden="true" role = "presentation" id="progress_bar" class="top">
          ...
          <li class="page-nav-item">
            ...
            <a href="#mark" class="trigger-scroll step1" data-target="mark"></a>
          </li>

          <li class="page-nav-item">
            <label for="step2" class="progress_flag">Step 2 of 7</label>
            <a href="#reasons" class="trigger-scroll step2" data-target="reasons"></a>
          </li>
          <li class="page-nav-item">
            <label for="step3" class="progress_flag">Step 3 of 7</label>
            <a href="#identify" class="trigger-scroll step3" data-target="identify"></a>
          </li>

          <li class="page-nav-item">
            <label for="step4" class="progress_flag">Step 4 of 7</label>
            <a href="#cravings" class="trigger-scroll step4" data-target="cravings"></a>
          </li>
          <li class="page-nav-item">
            <label for="step5" class="progress_flag">Step 5 of 7</label>
            <a href="#reminders" class="trigger-scroll step5" data-target="reminders"></a>
          </li>

          <li class="page-nav-item">
            <label for="step6" class="progress_flag">Step 6 of 7</label>
            <a href="#help" class="trigger-scroll step6" data-target="help"></a>
          </li>

          <li class="page-nav-item">
            <label for="step7" class="progress_flag">Step 7 of 7</label>
            <a href="#show" class="trigger-scroll step7" data-target="show"></a>
          </li>
        </ul>
