         ...
         <img src="/sites/all/modules/custom/icf_lgbt_app/src/assets/strong-enough-brush.png" className="brush" alt="background brush"  />
          <Row>
            ...
            <ul>
              ...
              <li>Call a quitline. Try <a href="tel:18007848669" target="_blank">1-800-QUIT-NOW</a>(1-800-784-8669) or <a href="tel:18774487848" target="_blank">1-877-44U-QUIT</a> (1-877-448-7848).</li>
              <li>Find an LGBT–friendly healthcare provider through the <a href="http://www.glma.org/index.cfm?fuseaction=Page.viewPage&pageId=939&grandparentID=534&parentID=938&nodeID=1" target="_blank">Gay and Lesbian Medical Association</a>.</li>
            </ul>
            </Col>
          </Row>
