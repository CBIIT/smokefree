        ...
        if(patch.checked === true) {
            this.setState({
                changes: {
                    ...
                    youSelected:[
                        {
                            iconPath: '..//sites/all/modules/custom/icfi_interactive_vet_react_app/build/images/nrt-selection-icons-2x.png',
                            title: 'Patch',
            ...
            this.setState({
                changes: {
                    ...
                    quickTips: [
                     ...
                     videoUrl: 'https://www.youtube.com/watch?v=LRMAM29TtTk',
            ...
            this.setState({
                changes: {
                    ...
                    quickTips: [
                     ...
                     quote: '"I quit today!”',
                     videoUrl: 'https://www.youtube.com/watch?v=7cIG8jlPwJw',
                     gifImage: '/sites/all/modules/custom/icfi_interactive_vet_react_app/build/images/SLIDER_BLUE-RED_GUM-LOZENGE.gif'
                }
            })
            ...
            this.setState({
                changes: {
                    ...
                    quickTips: [
                     ...
                     videoUrl: 'https://www.youtube.com/watch?v=5BcoasP1VOo',
            ...
            this.setState({
                changes: {
                    ...
                    quickTips: [
                     ...
                     videoUrl: 'https://www.youtube.com/watch?v=hfT4NU-NTY4',
        ...
        <div className="container">	
            <div className="row">
                <div id="nrt-selection">
                    ...
                    <div className="col-sm-3 col-xs-6">
                        <div className="checkbox nrt-selection card-gray">
                            <label id="gum"><input id="gum-box" name="nrt" onChange={checkBoxHandler.bind(this)} type="checkbox" className={`nrt-selection-checkbox ${this.state.changes.gumDisabled}`} value="" />Gum</label>
                        </div>
                    </div>
                    <div className="col-sm-3 col-xs-6">
                        <div className="checkbox nrt-selection card-gray">
                            <label id="lozenge"><input id="lozenge-box" name="nrt" onChange={checkBoxHandler.bind(this)} type="checkbox" className={`nrt-selection-checkbox ${this.state.changes.lozengeDisabled}`} value=""/>Lozenge</label>
                        </div>
                    </div>
                    <div className="col-sm-3 col-xs-6">
                        <div className="checkbox nrt-selection card-gray">
            ...
            <div className="row">
                ...
                <TherapySelection youSelected={this.state.changes.youSelected} factsSheetUrl={this.state.changes.factsSheetUrl} />
            </div>
            <div className="spacer-30"></div>
            <QuitTipsVideo videoUrl={this.state.changes.videoUrl} quickTips={this.state.changes.quickTips} />
            <div className="spacer-30"></div>
