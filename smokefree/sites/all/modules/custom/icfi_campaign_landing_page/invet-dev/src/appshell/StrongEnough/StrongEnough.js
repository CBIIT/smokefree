    ...
    render() {
      return (
        <div className="strongEnough">
         <img src="/modules/custom/icf_lgbt_app/react/src/assets/strong-enough-brush.png" className="brush" alt="background brush"  />
          <Row>
            ...
            <ul>
              <li>Set a quit date and create your personalized <a href="https://smokefree.gov/build-your-quit-plan" >quit plan</a>.</li>
              <li>Talk to a doctor about <a href="https://smokefree.gov/tools-tips/how-to-quit/medications-can-help-you-quit" >medications</a> and other ways to help you quit.</li>
