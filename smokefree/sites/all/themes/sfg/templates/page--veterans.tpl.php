...
<div class="tagline">
    <p>
        It doesn't matter where you start. <a class="jstart" href="build-your-quit-plan"><strong>Just start.</strong></a>
    </p>
</div>
...
<div class="main-container container">
    ...
    <div><img src="/<?php echo path_to_theme(); ?>/images/banner.jpg"/ alt="banner" style="width:100%"></div>
    <div class="row-fluid span12">
                        ...
                        <div id='VETSidebar'>
                            <ul>
                                ...
                                <li class='has-sub'><a id="M3" href='/veterans/how-to-quit'><span>How To Quit</span></a>
                                    <ul>
                                        <li><a id="quitplan" href='/veterans/how-to-quit/build-your-quit-plan' target='_blank'><span>Build Your Quit Plan</span></a></li>
        ...
        <?php if(isset($node) && !empty($node) && $node->nid != '144'): ?>
            ...
            <aside class="span3" role="complementary" style="background-color:#f0f0f0">
                    <div id="box1">
                        <img src="/<?php echo path_to_theme(); ?>/images/veterans-sidebar/rotate.php" alt="sidebar image"/>
                    </div>

                    <div id="box2">
                        <h3>QUITLINE</h3>
                        Quitlines are staffed by counselors who provide helpful information, advice and support. If you are ready to quit using tobacco, quitlines can help.<br> <br>
                        <img src="/<?php echo path_to_theme(); ?>/images/img2.jpg" alt="Smokefree hotline info picture">
                    </div>
                    ...
                    <div id="box3">
                        ...
                        <br> <br>
                        <img src="/<?php echo path_to_theme(); ?>/images/img1.jpg" alt="VETesp image">
                    </div>
                    <div id="box3">
                        <h3>Smokefree VET Facebook</h3>
                        SmokefreeVET is a mobile text messaging program that provides 24/7 tips, advice and encouragement to help you quit.
                        <br> <br>
                        <a href="http://facebook.com/smokefreevet"><img src="/<?php echo path_to_theme(); ?>/images/sidebar.png" alt="Join our community of smokefree Veterans on Facebook.  Facebook.com/smokefreevet"></a>
                    </div>
            </aside>
        <?php endif; ?>
    </div> <!-- end row -->
...
<div class="logobar">
    ...
    <div class="logobar half-width">
        <div class="social-container">
            <div class="logobar social">
                ...
                <div class="twitter-icon">
                    <a href="http://twitter.com/SmokeFreeUs"
                       title="Twitter"
        ...
        <div class="veterans links-container-txt">
            <div class="logobar links">
                <a href="/smokefreetxt"
                   ...
                   title="Smokefree TXT">
                    ...
                    <div class="veterans smokefree-txt-text">
                        <p><span title="SmokefreeTXT">SmokefreeTXT</span></p>
                    </div>
                </a>
            </div>
        </div>
        <div class="veterans links-container-qp">
            <div class="logobar links">
                <a href="/quit-plan"
                   class="logobar links"
                   title="Quit Plan">
                    ...
                    <div class="veterans quit-plan-text">
                        <p>Quit Plan</p>
                    </div>
                </a>
            </div>
