...
<div class="apps_text_promos col-sm-12">
  ...
  <div class="txt_promo col-sm-4">
    ...
    <?php elseif (strtolower($txt_display) == "dcpq") : ?>
      <div class="txt_promo_body">
        <div class="txt_promo_body_headline">Daily Challenges and Practice Quit</div>
        <div class="txt_promo_body_text">These new text message programs can help you practice quitting without committing. Sign up for Daily Challenges for 7 days of challenges or use the Practice Quit program to try to quit smoking for 1, 3, or 5 days.
          <div class="txt_promo_body_text_signup">
            <?php print l(t('Sign up now!'), 'practicequittxt', array('attributes' => array('class' => array('smokefreetxt_signup', 'medialanding_button', 'btn')))); ?>
          </div>
      </div>
      <div class="txt_promo_image">
        <?php print render($smokefreetxt_image); ?>
