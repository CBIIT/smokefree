    ...
    <footer>
        <div class="container">
            <div class="left-box col-lg-10">
                ...
                <!--Help Row Start-->
                <div class="help-row">
                    <a href="https://livehelp.cancer.gov/">LiveHelp</a> | <a href="/build-your-quit-plan">QuitPlan</a> | <a href="/smokefree-text-messaging-programs">SmokefreeTXT</a> | <a href="/mhealthmonitor/blog-index">mHealth Monitor</a>
                </div>
                <!--Help Row End-->
                <!--Site Map Row-->
