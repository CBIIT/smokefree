	...
	<footer>
		...
		<div class="container">
	      ...
	      <div class="footer-icons">
			    ...
			    <!--Help Row Start-->
			    <div class="help-row">
			    <a href="https://livehelp.cancer.gov/app/chat/chat_landing">LiveHelp</a> | <a href="/build-your-quit-plan">QuitPlan</a> | <a href="/smokefree-text-messaging-programs">SmokefreeTXT</a> | <a href="/mhealthmonitor/blog-index">mHealth Monitor</a>
			    </div>
			    <!--Help Row End-->
			    <!--Smokefree Icon Row Start-->
			     <!--Smokefree Icon Row LG Start-->
			    <div class="smokefree-row hidden-sm hidden-xs">
			   	<a href="http://smokefree.gov/veterans/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreevet@2x_release.png" width="117.18" height="15"></a>
			    <a href="http://women.smokefree.gov"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreewomen@2x_release.png" width="139.15" height="15"></a>
			    <a href="http://teen.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreeteen@2x_release.png" width="117.18" height="15"></a>
			    <a href="http://espanol.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreeespanol@2x_release.png" width="145.26" height="15"></a>
			    <a href="https://60plus.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefree60@2x_release.png" width="110.38" height="15"></a>
			    </div>
			    	<!--Smokefree Icon Row MD Start-->
			    <div class="smokefree-row hidden-md hidden-lg  hidden-xs">
			    <a href="http://smokefree.gov/veterans/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreevet@2x_release.png" width="107.77" height="15"></a>
			    <a href="http://women.smokefree.gov"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreewomen@2x_release.png" width="139.15" height="15"></a>
			    <a href="http://teen.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreeteen@2x_release.png" width="117.18" height="15"></a>
			    </div>
			    <div class="smokefree-row hidden-md hidden-lg hidden-xs">
			    ...
			    <a href="http://women.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreewomen@2x_release.png" width="139.15" height="15"></a>
			    <a href="http://teen.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreeteen@2x_release.png" width="117.18" height="15"></a>
			    <a href="http://espanol.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefreeespanol@2x_release.png" width="145.26" height="15" class="smmargin"></a>
			    <a href="https://60plus.smokefree.gov/"><img src="/<?php echo drupal_get_path('theme', 'smokefreegov'); ?>/images/footer/smokefree60@2x_release.png" width="110.38" height="15"></a>
			    </div>
