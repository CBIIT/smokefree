...
$html .= '</tr></table>
        ...
        <section id="get.identify">
            ...
            <p>Knowing your triggers helps you stay in control. When you first quit, you might want to avoid triggers altogether. After staying smoke-ßfree for a while, you may be able to find other ways to handle your triggers.</p>
...
$html .= '</section>
        ...
        <section id="get.help">
            ...
            <div id="get.help.apps">
                <h4>Medications and Nicotine Replacement Therpy (NRT)</h4>
                <p>Using medications and/or nicotine replacement therapy (NRT) can improve your chances of quitting for good (<a href="http://www.publichealth.va.gov/smoking/quit/medications.asp">http://www.publichealth.va.gov/smoking/quit/medications.asp</a>). Make an appointment with your health care provider to find out which options are best for you.</p>
            </div>';

if(isset($_POST["help_smokefreeVet"])) {
    $html .= '<div id="get.help.smokefreeVet">
                <h4>SmokefreeVET Text Message Program</h4>
                <p>SmokefreeVET is a mobile text messaging service for military Veterans who receive their healthcare through VA. Sign up online (<a href="http://smokefree.gov/vet">http://smokefree.gov/vet</a>) or send a text message with the word VET to 47848.</p>
            </div>
';
}
if(isset($_POST["help_apps"])) {
    $html .= '<div id="get.help.apps">
                <h4>Apps</h4>
                <ul class="plan-ul">
                    <li>QuitGuide (<a href="http://smokefree.gov/apps-quitguide">http://smokefree.gov/apps-quitguide</a>) helps you track cravings, monitor progress, and gives you strategies to help you become smokefree. </li>
                    <li>VA’s Stay Quit Coach (<a href="https://mobile.va.gov/app/stay-quit-coach">https://mobile.va.gov/app/stay-quit-coach</a>) was designed to help Veterans with Post-Traumatic Stress Disorder (PTSD) quit smoking. This app has been shown to double quit rates for Veterans with PTSD. </li>
                </ul>
            </div>';
}
if(isset($_POST["help_facebook"])) {
    $html .= ' <div id="get.help.facebook">
                ...
                <p>Get extra support and information by checking out SmokefreeVET on Facebook (<a href="https://www.facebook.com/smokefreevet">https://www.facebook.com/smokefreevet</a>). </p>
            </div>';
}
if(isset($_POST["help_quitlines"])) {
    $html .= '<div id="get.help.quitlines">
                ...
                <p>The VA quitline (<a href="http://www.publichealth.va.gov/smoking/quitline.asp" target="_blank">http://www.publichealth.va.gov/smoking/quitline.asp</a>) is for Veterans who receive their healthcare through VA: 1-855-QUIT-VET (1-855-784-8838)</p>

                <p>If you do not receive healthcare through VA, consider these options:</p>

                <ul class="plan-ul">
                    <li><strong>The National Cancer Institute quitline:</strong> 1-877-44U-QUIT (1-877-448-7848)</li>
                    <li><strong>Find your state’s quitline:</strong> 1-800-QUIT-NOW (1-800-784-8669)</li>
                </ul>
            </div>';
}
