<div class="container-page">
    <nav class="scrollmenu">
        <div class="container">
            ...
            <a href="https://veterans.smokefree.gov" id="smokefree-vet"><img src="/sites/all/themes/smokefreeteen/dist/images/smokefree-vet.png" alt="smokefree-vet"></a>
  ...
  <div id="sticky">
    ...
    <div class="header-col-12 search-bar" >
        <form class="search-bar-form" action="https://websrch.cit.nih.gov/sps/SMOKEFREE_TEEN/Results.html?" method="get" name="search" onsubmit="javascript:if (document.getElementById('searchbox-header').value=='Search'
