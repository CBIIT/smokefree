...
<?php endif; ?>
  ...
  <div class="container margin-top-lg">
    <div class="row">
      <div class="col-md-8 col-sm-12 article-container">
        <!-- Breadcrumbs -->
        <?php if ($show_breadcrumbs && !empty($breadcrumb)): ?>
          ...
          <img src="/sites/all/themes/smokefreeteen/src/images/smokefreeteen_logo@2x.png" class="img-responsive" alt="Smokefree teen logo.">
          </div>
        <?php endif; ?>
      ...
      <?php if (!empty($page['sidebar_second'])): ?>
        <div class="col-md-4 col-sm-12 sidebar-container">
