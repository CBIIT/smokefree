    ...
    <footer>
        <div class="container">
            <div class="left-box">
                ...
                <!--Help Row Start-->
                <div class="help-row">
                    <a href="https://livehelp.cancer.gov/app/chat/chat_landing">LiveHelp</a> | <a href="https://smokefree.gov/build-your-quit-plan">QuitPlan</a> | <a href="https://smokefree.gov/smokefree-text-messaging-programs">SmokefreeTXT</a> | <a href="https://smokefree.gov/mhealthmonitor/blog-index">mHealth Monitor</a>
                </div>
                <!--Help Row End-->
                <!--Site Map Row-->
            ...
            <!--Widget Column Start-->
            <div class="widget-box col-lg-2">
                <a href="https://betobaccofree.hhs.gov" target="_blank" class="tobacco-free-widget">Learn More @BeTobaccoFree.gov</a>
            </div>

        </div>
        <div class="col-lg-12">
            <div class="nihtagline">NIH… Turning Discovery Into Health<sup>®</sup></div>
        </div>
    </footer>
</div>
