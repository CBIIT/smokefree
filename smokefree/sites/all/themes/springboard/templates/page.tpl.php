		...
		<div class="row">
			<div class="col-md-5">
				<div class="sbc-logo-tagline">
					<a href="/springboard"><img src="/sites/all/themes/springboard/images/SBC-logo-footer.png" alt="Springboard Beyond Cancer logo" id="sbc-footer-logo" class="border-right"></a>
